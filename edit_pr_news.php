...
$grab = mysql_query("SELECT * FROM TN_pr_news WHERE id LIKE '$id'");
...
<?php include "share/home_nav.php"; ?>
                ...
                <div id="main">
<h3>Home Decore Slot</h3>
<?php echo $error; ?>
      
<form action="make_pr_news.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<fieldset>
      ...
      <input type="hidden" name="cat" id="cat" value="<?php echo $cat; ?>" class="text-long" /></p>
       <input type="hidden" name="id" id="id" value="<?php echo $id; ?>" class="text-long" />
