...
<?php include "share/work_nav.php"; ?>
                ...
                <h2><a href="#">Admin</a> &raquo; <a href="#" class="active"> Finish Work </a></h2>
                
                <div id="main">
<div class="slider_form"><br />
The work has been added.<br />
<br />
<br /><strong>Category:</strong> <?php echo $cat; ?><BR />
...
<a href="http://thatsnice.com/admin/create_work.php">Make Another?</a> </div>
<br /><br />
                </div>
                <!-- // #main -->
