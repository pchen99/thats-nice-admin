...
<?php include "share/home_nav.php"; ?>
                ...
                <h2><a href="#">Admin</a> &raquo; <a href="#" class="active">Nice Short News</a></h2>
                
                <div id="main">
<h3>Add To Nice Short News Pool</h3>
<?php echo $error; ?>
      
<form action="make_ns_news.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
{	
  ...
  if ($active == 0) {
  echo "<td class=\"action\"><a href=\"enable_ns_news.php?id=$id\" class=\"edit\">Disabled</a></td>";
  }
   if ($active == 1) {
  echo "<td class=\"action\"><a href=\"disable_ns_news.php?id=$id\" class=\"edit\">Enabled</a></td>";
  }
