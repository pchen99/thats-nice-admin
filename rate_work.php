...
<?php include "share/work_nav.php"; ?>
                ...
                <h2><a href="#">Admin</a> &raquo; <a href="#" class="active">Work Section</a></h2>
...
// -- Fetch the data --------//
$grab = mysql_query("SELECT * FROM TN_work WHERE rating = '0' order by title");
...
<br />
<input name="subby" type="submit" value="Add Rating" />
</form>
