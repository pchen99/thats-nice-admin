...
<?php include "share/admin_nav.php"; ?>
                ...
                <h2><a href="#">Admin</a> &raquo; <a href="#" class="active">Admin Tools</a></h2>
                
                <div id="main">

  <h3>Admin Tools</h3>
<p><strong>Case Study Admin</strong><br />
- Enable / Disable <br />
- Achive / Make Live<br />
- Delete Case Study </p>
<br />

<p><strong>Work Section Admin</strong><br />
- Enable / Disable <br />
- Achive / Make Live<br />
- Delete Work Sub Section<br />
- Delete Work Parent Section From options list</p>
<br />
