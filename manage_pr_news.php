...
<body>
	<div id="wrapper">
    	...
    	<h1><a href="index.php"><span>Project News Admin</span></a></h1>
...
<?php include "share/home_nav.php"; ?>
                ...
                <h2><a href="#">Admin</a> &raquo; <a href="#" class="active">Project News</a></h2>
...
<form action="create_pr_news.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
// -- Fetch the data --------//
$grab = mysql_query("SELECT * FROM TN_pr_news WHERE cat='$cat' ORDER BY id ASC");
...
{	
  ...
  echo "
    <tr>
      <td>$headline</td>
	  <td class=\"action\"><a href=\"edit_pr_news.php?id=$id&cat=$cat\" class=\"view\">Edit</a></td>
	  ";
	  
    if ($active == 1) {
	echo "<td class=\"action\"><font color=\"green\">Active</font></td>";
	} else { 
	echo "<td class=\"action\"><a href=\"activate_pr_news.php?id=$id&cat=$cat\">Select</a></td>";
	}
	
	echo "<td class=\"action\"><a href=\"delete_pr_news.php?id=$id&cat=$cat\" class=\"delete\">Delete</a></td>
	</tr>";
