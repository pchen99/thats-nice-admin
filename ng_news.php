...
<?php include "share/home_nav.php"; ?>
                ...
                <h2><a href="#">Admin</a> &raquo; <a href="#" class="active">Nice Gift News</a></h2>
                
                <div id="main">
<h3>Add To Nice Gift News Pool</h3>
<?php echo $error; ?>
      
<form action="make_ng_news.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
// -- Fetch the data --------//
$grab = mysql_query("SELECT * FROM TN_ng_news ORDER BY id ASC");
...
{	
  ...
  echo "
    <tr>
      <td>$headline</td>
	  <td>$title2</td>
	  <td class=\"action\"><a href=\"edit_ng_news.php?id=$id\" class=\"view\">Edit</a></td>
	  <td class=\"action\"><a href=\"delete_ng_news.php?id=$id\" class=\"delete\">Delete</a></td>";
  if ($active == 0) {
  echo "<td class=\"action\"><a href=\"enable_ng_news.php?id=$id\" class=\"edit\">Disabled</a></td>";
  }
   if ($active == 1) {
  echo "<td class=\"action\"><a href=\"disable_ng_news.php?id=$id\" class=\"edit\">Enabled</a></td>";
  }
