...
<h3>Add Latest News</h3>
    <p>Add and remove from the latest news pool below. A random news bait will be used from this list.</p>  <br />
<form action="make_latest_news.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
