...
$insert_data = "UPDATE TN_cl_news SET headline = '$headline', copy = '$copy', link_text = '$link_text', h = '$h', w = '$w', src = '$src', m = '$m', d = '$d', y = '$y', datestamp = '$date' WHERE id = '$id'";
mysql_query($insert_data) or die ( mysql_error() );

if($link_type !== "") {
$insert_data = "UPDATE TN_cl_news SET link_type = '$link_type' WHERE id = '$id'";
mysql_query($insert_data) or die ( mysql_error() );
}

if($img !== "") {
$insert_data = "UPDATE TN_cl_news SET img = '$img' WHERE id = '$id'";
mysql_query($insert_data) or die ( mysql_error() );
}

if($np_img !== "") {
$insert_data = "UPDATE TN_cl_news SET image = '$np_img' WHERE id = '$id'";
mysql_query($insert_data) or die ( mysql_error() );
}
