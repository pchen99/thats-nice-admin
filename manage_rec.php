...
<form action="make_rec.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

<fieldset>
    
      <p>Project<br>
      <input type="text" name="project" id="project"  class="text-long" /></p>
      
      <p>Client<br>
      <input type="text" name="client" id="client"  class="text-long" /></p>
      
      <p>Publication<br>
      <input name="publication"  type="text" class="text-long" > 
      </p>
        
     <p>Publisher<br />
      <input type="text" name="publisher" id="publisher" class="text-long" />
     </p>
     
     <p>Award<br />
      <input type="text" name="Award" id="Award" class="text-long" />
     </p>
     ...
     <p>Custom Field<br />
     <input type="text" name="custom_field" id="custom_field" class="text-long" />
     </p>
     
     <p>Custom Data<br />
     <input type="text" name="custom_data" id="custom_data" class="text-long" />
     </p>
     
     <p>Year<br />
     <input name="year" type="text" class="text-small" id="year" size="4" maxlength="4" />
     </p>
     
     <p>Link<br />
     <input name="link" type="text" class="text-long" id="link" />
     </p>
     
     <p>Image <span class="smaller_font">75 x 51</span><br>
