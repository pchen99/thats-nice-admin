...
$grab = mysql_query("SELECT * FROM TN_cl_news WHERE id LIKE '$id'");
...
<?php include "share/home_nav.php"; ?>
                ...
                <div id="main">
<h3>Edit client news</h3>
<?php echo $error; ?>
      
<form action="make_cl_news.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

<fieldset>
    
      <p>Headline<br>
      <input type="text" name="headline" id="headline" value="<?php echo $hd_headline; ?>" class="text-long" />
      <input type="hidden" name="cat" id="cat" value="<?php echo $cat; ?>" class="text-long" />
      <input type="hidden" name="id" id="id" value="<?php echo $id; ?>" class="text-long" /></p>
