...
<?php include "share/home_nav.php"; ?>
                ...
                <div id="main">
<h3>Add To Nice Exhibit News Pool</h3>
<?php echo $error; ?>
      
<form action="make_ne_news.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
// -- Fetch the data --------//
$grab = mysql_query("SELECT * FROM TN_ne_news ORDER BY id ASC");
...
{	
  ...
  echo "
    <tr>
      <td>$headline</td>
	  <td>$title2</td>
	  <td class=\"action\"><a href=\"edit_ne_news.php?id=$id\" class=\"view\">Edit</a></td>
	  <td class=\"action\"><a href=\"delete_ne_news.php?id=$id\" class=\"delete\">Delete</a></td>";
  if ($active == 0) {
  echo "<td class=\"action\"><a href=\"enable_ne_news.php?id=$id\" class=\"edit\">Disabled</a></td>";
  }
   if ($active == 1) {
  echo "<td class=\"action\"><a href=\"disable_ne_news.php?id=$id\" class=\"edit\">Enabled</a></td>";
  }
