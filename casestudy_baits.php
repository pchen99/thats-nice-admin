...
<?php include "share/cs_nav.php"; ?>
                ...
                <h2><a href="#">Admin</a> &raquo; <a href="#" class="active">Select Case Study</a></h2>
                
                <div id="main">

<?php echo $error; ?>
      
<form action="manage_cs_baits.php" method="post" enctype="multipart/form-data" name="form1" id="form1">

<fieldset>
    
      <p> <b> Select Case Study </b> <br />
      <select name="cs">
<?php 
